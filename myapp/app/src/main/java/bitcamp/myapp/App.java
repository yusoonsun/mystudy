...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // "등록 이라는 메뉴를 선택했을 때 BoardAddHandler 를 실행시키는 일을 한다.
    ...
    helpMenu.add(new MenuItem("조회"));
    helpMenu.add(new MenuItem("변경"));
    helpMenu.add(new MenuItem("삭제"));
    helpMenu.add(new MenuItem("목록"));
