...
public class App {
  ...
  static final String ANSI_CLEAR = "\033[o";
  ...
  public static void main(String[] args) {
    ...
    java.util.Scanner keyIn = new java.util.Scanner(System.in); // System.in 조건문 실행
    ...
    keyIn.close();  // break; 종료 시 추가
  }

  static void printMenu() {
    // ANSI 코드와 App 제목, 메뉴를 저장한 변수를 메서드 안에 두는 대신에
    // 클래스 블록 안에 두면
    // pritnMenu()를 호출할 때마다 변수를 만들지 않기 때문에 실행 속도나 메모리 부분에서
    // 훨씬 효율적이다.
